...
const Listing = () => {
  ...
  const dirId = location.pathname.split("/")[2];


  useEffect(() => {
    console.log("Use state runs");
    const FetchData = () => {
      let getSubDirectoryContents = new GetDirectoryContentsRequest();
      getSubDirectoryContents.setId(dirId);
      getSubDirectoryContents.setToken(userToken)
      console.log(decodedToken)
      
      client.getDirectoryContents(getSubDirectoryContents, {}, (err, response) => {
